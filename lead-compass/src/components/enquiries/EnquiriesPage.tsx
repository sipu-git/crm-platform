...
import { EnquiriesPageProps } from "@/components/enquiries/enquiries.constants";
import { EnquiriesCharts } from "@/components/enquiries/EnquiriesCharts";
import { EnquiriesToolbar } from "@/components/enquiries/EnquiriesToolbar";
import { EnquiriesTable } from "@/components/enquiries/EnquiriesTable";
import { EnquiriesDeleteDialog } from "@/components/enquiries/EnquiriesDeleteDialog";
import { PageHeader } from "@/components/ui-kit";

const KpiGridWidgets = lazy(() =>
  import("@/components/dashboard/widgets/KpiGridWidget").then((module) => ({
