...
function noMixedTaxRegime(data: { cgst_rate?: number; sgst_rate?: number; igst_rate?: number }) {
...
export type ListInvoiceItemsQuery = z.infer<typeof listInvoiceItemsQuerySchema>;